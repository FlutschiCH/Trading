...
class TradeAnalyzerHandler:
    @staticmethod
    def analyze_trades(account_id: int = None, date_from: int = None, date_to: int = None, **kwargs) -> Dict[str, Any]:
        """
        Fetches deals/trades from MetaTrader 5, calculates performance metrics,
        and constructs an LLM-ready analysis JSON prompt.
        """
        deals = MetaTraderHandler.get_history(date_from=date_from, date_to=date_to, account_id=account_id, **kwargs)
