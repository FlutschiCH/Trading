...
import { Play, Pause, Trash2, Edit2, Clock, CheckCircle2, AlertTriangle, RefreshCw, X, ShieldAlert, Cpu, ExternalLink } from 'lucide-react';
...
export default function LiveOverviewPanel({ 
  ...
  const isMobile = isMobileLayout || isMobileScreen;
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '8px', marginBottom: '12px', borderBottom: '1px solid var(--app-card-border, #1f2937)', paddingBottom: '8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          <span style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 'bold' }}>
            LIVE STRATEGIES ({strategies.length})
          </span>
          <DebugComponentBadge name="LiveOverviewPanel" />
          <button
              ...
              >
                ...
                {!isPaused ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '11px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '4px 8px', borderBottom: '1px solid var(--app-card-border, #111827)', paddingBottom: '6px', fontSize: '10px', color: 'var(--app-text-muted, #94a3b8)' }}>
                      <div>
                        <span>Lookback: </span>
