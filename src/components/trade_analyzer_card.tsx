    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ fontSize: '14px', fontWeight: 600, color: 'var(--app-text, #f3f4f6)' }}>
            Trade Analyzer (MetaTrader Deals)
          </span>
        </div>
      ...
      {summary && (
        <div style={{
          ...
          <div style={{ backgroundColor: '#0f172a', border: '1px solid #1e293b', borderRadius: '6px', padding: '10px' }}>
            <span style={{ fontSize: '11px', color: '#94a3b8', display: 'block' }}>Total Trades</span>
            <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#f8fafc' }}>{summary.total_trades}</span>
          </div>

          <div style={{ backgroundColor: '#0f172a', border: '1px solid #1e293b', borderRadius: '6px', padding: '10px' }}>
            <span style={{ fontSize: '11px', color: '#94a3b8', display: 'block' }}>Win Rate</span>
            <span style={{ fontSize: '16px', fontWeight: 'bold', color: summary.win_rate >= 50 ? '#10b981' : '#f87171' }}>
              {summary.win_rate}%
            </span>
          </div>

          <div style={{ backgroundColor: '#0f172a', border: '1px solid #1e293b', borderRadius: '6px', padding: '10px' }}>
            <span style={{ fontSize: '11px', color: '#94a3b8', display: 'block' }}>Net PnL</span>
            <span style={{ fontSize: '16px', fontWeight: 'bold', color: summary.net_pnl >= 0 ? '#10b981' : '#f87171' }}>
              {summary.net_pnl >= 0 ? `+$${summary.net_pnl}` : `-$${Math.abs(summary.net_pnl)}`}
            </span>
          </div>

          <div style={{ backgroundColor: '#0f172a', border: '1px solid #1e293b', borderRadius: '6px', padding: '10px' }}>
            <span style={{ fontSize: '11px', color: '#94a3b8', display: 'block' }}>Profit Factor</span>
            <span style={{ fontSize: '16px', fontWeight: 'bold', color: summary.profit_factor >= 1.5 ? '#10b981' : '#f59e0b' }}>
              {summary.profit_factor}
            </span>
          </div>

          <div style={{ backgroundColor: '#0f172a', border: '1px solid #1e293b', borderRadius: '6px', padding: '10px' }}>
            <span style={{ fontSize: '11px', color: '#94a3b8', display: 'block' }}>Max Drawdown</span>
