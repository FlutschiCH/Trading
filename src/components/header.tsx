...
export default function Header({
  ...
  accounts,
  handleSwitchAccount,
  setShowAccountModal: externalSetShowAccountModal,
  handleRestartServer,
  setView,
  styles,
  onToggleLandscape,
  ...
  const [internalAccountModalOpen, setInternalAccountModalOpen] = useState(false);

  const openAccountModal = () => {
    setInternalAccountModalOpen(true);
  };
  ...
  return (
    <header style={{
      ...styles.header,
      ...(isMobile ? { padding: '8px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative' } : {})
    }}>
      {isMobile ? (
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
            <Activity size={20} style={{ color: '#3b82f6' }} />
            <span style={{ ...styles.logoText, fontSize: '15px' }}>WYCKOFF</span>
            <span 
              ...
              style={{
                ...
                boxShadow: `0 0 6px ${currentConnected ? '#10b981' : '#ef4444'}`,
                display: 'inline-block',
              }}
            />
            <DebugComponentBadge name="Header" />
          </div>

          {/* Always Visible Compact Account Selector for Mobile */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', minWidth: '0', flex: 1, justifyContent: 'flex-end', margin: '0 4px' }}>
            ...
            {accountInfo && (
              <span style={{
                ...
                ${accountInfo.balance >= 1000 ? `${(accountInfo.balance / 1000).toFixed(1)}k` : accountInfo.balance.toFixed(0)}
              </span>
            )}
          </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                  ...
                  <button
                    onClick={() => {
                      ...
                      window.open('http://89.217.138.51:8020/api/live/strategies', '_blank');
                    }}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%', gap: '10px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                          ...
                          <button
                            ...
                            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                          >
                            <span style={{ fontSize: '14px' }}>📰</span> Trading News
                          </button>
          ...
          <div style={{
            ...
            <button
              ...
              title="Refresh Account Info & Positions"
            >
              <RefreshCw size={12} />
              Refresh
            </button>
      ...
      <AccountManagement
        isOpen={internalAccountModalOpen}
        onClose={() => setInternalAccountModalOpen(false)}
      />
    </header>
  );
}
